...
class PreferencesDialog(QDialog):
    ...
    def init_ui(self):
        ...
        url_label = QLabel("Embedding URL:")
    ...
    def load_settings(self):
        self.url_edit.setText(self.settings.value("embedding_service/url", ""))
    ...
    def save_settings(self):
        self.settings.setValue("embedding_service/url", self.url_edit.text())
